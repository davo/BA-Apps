...
function homepageInitialize() {
    ...
    function t(e) {
        ...
        return t -= d / 2, n -= d / 2, t = i * t * N / (N + o * t), n = i * n * N / (N + o * n), t += d / 2, 
        n += d / 2, [ t, n ];
    }
    function n() {
        if (!(.001 > Math.abs(u - p))) {
    ...
    function r() {
        if (S) {
            var e = v.width(), n = v.height(), r = Math.min(e / (.75 * n), 1);
    ...
    function i(t) {
        if (S) {
            ...
            .005 > Math.abs(1 - s) && (v.unbind("resize", r), C || v.unbind("scroll", i), C && k(), $(".crumpled-box").remove(), 
            setTimeout(function() {
                v.scrollTop(0), w.remove(), $(".content-wrapper").removeClass("inactive"), $("html").addClass("curtain-removed"), 
                contentInitialize();
            }, 50), S = !1);
        }
    }
    ...
    function a() {
        C ? (l -= 30, f >= l && (l = f, clearInterval(c)), i({
            ...
            deltaY: l
        })) : (l += 30, l >= f && (l = f, clearInterval(c)), v.scrollTop(l));
    }
    function s() {
        C ? (l = -m, f = m - h / 2) : (l = v.scrollTop(), f = h / 2), c = setInterval(a, 30);
    }
    var u, c, l, f, p = 0, d = 0, h = 0, m = 0, g = 0, v = $(window), y = $(".line-wrapper"), b = $(".gradient"), x = $(".line"), w = $(".homepage-height-stub"), T = $(".crumpled-box"), E = Modernizr.csstransforms3d, C = Modernizr.touch, k = null, S = !0, N = 1300, j = 70;
    E ? y.css({
        "-webkit-perspective": N + "px",
        "-moz-perspective": N + "px",
        "-ms-perspective": N + "px",
        "-o-perspective": N + "px",
        perspective: N + "px"
    }) : y.css("position", "relative"), v.bind("resize", r), C || v.bind("scroll", i), C && (k = v.RMDrag({
        move: i,
        end: o,
        silent: !1,
        type: "touch",
...
function contentInitialize() {
    ...
    function i() {
        ...
        v.toggleClass("valid", e(y.val()));
    }
    function o() {
        v.hasClass("valid") && $.post("/api/emailme/", {
            email: y.val()
        }, function() {
            v.addClass("submitted"), y.remove();
        }).error(function() {
            v.addClass("submitted"), y.remove();
        });
    }
    ...
    var v = $(".page.page-beta .email"), y = v.find(".input"), b = v.find(".submit");
    y.bind("input propertychange", i).bind("keypress keyup keydown", function(e) {
        e.stopPropagation();
    }).bind("keyup", function(e) {
        e.stopPropagation(), 13 == e.keyCode && o();
    }).blur(), b.bind("click", o), d.on("touchstart", function(e) {
        y.is(":focus") && (y.blur(), e.stopPropagation());
    }), a();
}
...
(function(e, t) {
    ...
    function o(e, n, r) {
        var i;
        if (r === t && 1 === e.nodeType) if (i = "data-" + n.replace(yt, "-$1").toLowerCase(), r = e.getAttribute(i), 
        "string" == typeof r) {
            try {
    ...
    function C(e, t, n) {
        ...
        if (0 >= i || null == i) {
            if (i = zt(e, t, o), (0 > i || null == i) && (i = e.style[t]), Ut.test(i)) return i;
    ...
    function k(e) {
        var t = X, n = Vt[e];
        return n || (n = S(e, t), "none" !== n && n || (Bt = (Bt || ot("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), 
        t = (Bt[0].contentWindow || Bt[0].contentDocument).document, t.write("<!doctype html><html><body>"), 
        t.close(), n = S(e, t), Bt.detach()), Vt[e] = n), n;
    }
    function S(e, t) {
    ...
    function N(e, t, n, r) {
        ...
        if (ot.isArray(t)) ot.each(t, function(t, i) {
            n || tn.test(e) ? r(e, i) : N(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r);
        }); else if (n || "object" !== ot.type(t)) r(e, t); else for (i in t) N(e + "[" + i + "]", t[i], n, r);
    }
    function j(e) {
        return function(t, n) {
    ...
    function L(e, t, n) {
        for (var r, i = (Ln[t] || []).concat(Ln["*"]), o = 0, a = i.length; a > o; o++) if (r = i[o].call(n, t, e)) return r;
    }
    function P(e, t, n) {
        var r, i, o = 0, a = On.length, s = ot.Deferred().always(function() {
            ...
            if (i) return !1;
            for (var t = jn || O(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, a = 0, u = c.tweens.length; u > a; a++) c.tweens[a].run(o);
        ...
        for (R(l, c.opts.specialEasing); a > o; o++) if (r = On[o].call(c, e, l, c.opts)) return r;
        return ot.map(l, L, c), ot.isFunction(c.opts.start) && c.opts.start.call(e, c), ot.fx.timer(ot.extend(u, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    function F(e, n, r) {
        ...
        if (!ot.isEmptyObject(f)) {
            ...
            for (i in f) s = L(d ? h[i] : 0, i, l), i in h || (h[i] = s.start, d && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0));
        }
    }
    function $(e, t, n, r, i) {
    ...
    var I, z, B = typeof t, W = e.location, X = e.document, Y = X.documentElement, U = e.jQuery, G = e.$, V = {}, J = [], K = "2.0.2", Q = J.concat, Z = J.push, et = J.slice, tt = J.indexOf, nt = V.toString, rt = V.hasOwnProperty, it = K.trim, ot = function(e, t) {
    ...
    ot.fn = ot.prototype = {
        ...
        noConflict: function(t) {
            return e.$ === ot && (e.$ = G), t && e.jQuery === ot && (e.jQuery = U), ot;
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function(e) {
            (e === !0 ? --ot.readyWait : ot.isReady) || (ot.isReady = !0, e !== !0 && --ot.readyWait > 0 || (z.resolveWith(X, [ ot ]), 
        ...
        return z || (z = ot.Deferred(), "complete" === X.readyState ? setTimeout(ot.ready) : (X.addEventListener("DOMContentLoaded", dt, !1), 
        e.addEventListener("load", dt, !1))), z.promise(t);
        ...
        function n(e, t, n, r) {
            ...
            if ($ && !r) {
                if (i = Et.exec(e)) if (a = i[1]) {
                    ...
                    if ((a = i[3]) && N.getElementsByClassName && t.getElementsByClassName) return it.apply(n, t.getElementsByClassName(a)), 
                    n;
                }
                if (N.qsa && (!q || !q.test(e))) {
                    if (f = l = B, p = t, d = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (c = m(e), (l = t.getAttribute("id")) ? f = l.replace(St, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", 
                        u = c.length; u--; ) c[u] = f + g(c[u]);
                        p = vt.test(e) && t.parentNode || t, d = c.join(",");
                    }
                    if (d) try {
        ...
        function m(e, t) {
            ...
            return t ? s.length : s ? n.error(e) : G(e, u).slice(0);
        }
        function g(e) {
        ...
        function v(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                } else for (;t = t[r]; ) if (1 === t.nodeType || i) if (c = t[B] || (t[B] = {}), (u = c[r]) && u[0] === l) {
        ...
        function x(e, t, n, r, i, a) {
            return r && !r[B] && (r = x(r)), i && !i[B] && (i = x(i, a)), o(function(o, a, s, u) {
                var c, l, f, p = [], d = [], h = a.length, m = o || E(t || "*", s.nodeType ? [ s ] : s, []), g = !e || !o && t ? m : b(m, p, e, s, u), v = n ? i || (o ? e : h || r) ? [] : a : g;
                if (n && n(g, v, s, u), r) for (c = b(v, d), r(c, [], s, u), l = c.length; l--; ) (f = c[l]) && (v[d[l]] = !(g[d[l]] = f));
                if (o) {
                    if (i || e) {
                        if (i) {
                        ...
                        for (l = v.length; l--; ) (f = v[l]) && (c = i ? st.call(o, f) : p[l]) > -1 && (o[c] = !(a[c] = f));
                    }
                } else v = b(v === a ? v.splice(h, v.length) : v), i ? i(null, a, v, u) : it.apply(a, v);
            });
        }
        function w(e) {
            for (var t, n, r, i = e.length, o = A.relative[e[0].type], a = o || A.relative[" "], s = o ? 1 : 0, u = v(function(e) {
                return e === t;
            }, a, !0), c = v(function(e) {
                return st.call(t, e) > -1;
            }, a, !0), l = [ function(e, n, r) {
                return !o && (r || n !== O) || ((t = n).nodeType ? u(e, n, r) : c(e, n, r));
            } ]; i > s; s++) if (n = A.relative[e[s].type]) l = [ v(y(l), n) ]; else {
                if (n = A.filter[e[s].type].apply(null, e[s].matches), n[B]) {
        ...
        function T(e, t) {
            var r = 0, i = t.length > 0, a = e.length > 0, s = function(o, s, u, c, l) {
                var f, p, d, h = [], m = 0, g = "0", v = o && [], y = null != l, x = O, w = o || a && A.find.TAG("*", l && s.parentNode || s), T = X += null == x ? 1 : Math.random() || .1;
                for (y && (O = s !== R && s, j = r); null != (f = w[g]); g++) {
                    if (a && f) {
                ...
                if (m += g, i && g !== m) {
                    ...
                    if (o) {
                        if (m > 0) for (;g--; ) v[g] || h[g] || (h[g] = nt.call(c));
                        h = b(h);
                    }
                    it.apply(c, h), y && !o && h.length > 0 && m + t.length > 1 && n.uniqueSort(c);
                }
                return y && (X = T, O = x), v;
            };
            return i ? o(s) : s;
        ...
        function C(e, t, n, r) {
            var i, o, a, s, u, c = m(e);
            if (!r && 1 === c.length) {
                if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && N.getById && 9 === t.nodeType && $ && A.relative[o[1].type]) {
                    if (t = (A.find.ID(a.matches[0].replace(Nt, jt), t) || [])[0], !t) return n;
                    e = e.slice(o.shift().value.length);
                }
                for (i = wt.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !A.relative[s = a.type]); ) if ((u = A.find[s]) && (r = u(a.matches[0].replace(Nt, jt), vt.test(o[0].type) && t.parentNode || t))) {
                    if (o.splice(i, 1), e = r.length && g(o), !e) return it.apply(n, r), n;
                    break;
                }
            }
            return M(e, c)(r, t, !$, n, vt.test(e)), n;
        }
        function k() {}
        var S, N, j, A, D, _, M, O, L, P, R, F, $, q, H, I, z, B = "sizzle" + -new Date(), W = e.document, X = 0, Y = 0, U = i(), G = i(), V = i(), J = !1, K = function() {
            return 0;
        }, Q = typeof t, Z = 1 << 31, et = {}.hasOwnProperty, tt = [], nt = tt.pop, rt = tt.push, it = tt.push, at = tt.slice, st = tt.indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++) if (this[t] === e) return t;
            return -1;
        }, ut = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ct = "[\\x20\\t\\r\\n\\f]", lt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ft = lt.replace("w", "w#"), pt = "\\[" + ct + "*(" + lt + ")" + ct + "*(?:([*^$|!~]?=)" + ct + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + ft + ")|)|)" + ct + "*\\]", dt = ":(" + lt + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + pt.replace(3, 8) + ")*)|.*)\\)|)", ht = RegExp("^" + ct + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ct + "+$", "g"), mt = RegExp("^" + ct + "*," + ct + "*"), gt = RegExp("^" + ct + "*([>+~]|" + ct + ")" + ct + "*"), vt = RegExp(ct + "*[+~]"), yt = RegExp("=" + ct + "*([^\\]'\"]*)" + ct + "*\\]", "g"), bt = RegExp(dt), xt = RegExp("^" + ft + "$"), wt = {
            ID: RegExp("^#(" + lt + ")"),
            CLASS: RegExp("^\\.(" + lt + ")"),
        ...
        }, Tt = /^[^{]+\{\s*\[native \w/, Et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Ct = /^(?:input|select|textarea|button)$/i, kt = /^h\d$/i, St = /'|\\/g, Nt = RegExp("\\\\([\\da-f]{1,6}" + ct + "?|(" + ct + ")|.)", "ig"), jt = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        _ = n.isXML = function(e) {
            ...
            return n !== R && 9 === n.nodeType && n.documentElement ? (R = n, F = n.documentElement, $ = !_(n), 
            i && i.frameElement && i.attachEvent("onbeforeunload", function() {
                ...
                return F.appendChild(e).id = B, !n.getElementsByName || !n.getElementsByName(B).length;
            }), N.getById ? (A.find.ID = function(e, t) {
                if (typeof t.getElementById !== Q && $) {
                    var n = t.getElementById(e);
                    return n && n.parentNode ? [ n ] : [];
                }
            }, A.filter.ID = function(e) {
                var t = e.replace(Nt, jt);
                return function(e) {
            ...
            }), A.find.TAG = N.getElementsByTagName ? function(e, n) {
                ...
                return o;
            }, A.find.CLASS = N.getElementsByClassName && function(e, n) {
                return typeof n.getElementsByClassName !== Q && $ ? n.getElementsByClassName(e) : t;
            }, H = [], q = [], (N.qsa = r(n.querySelectorAll)) && (a(function(e) {
                e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || q.push("\\[" + ct + "*(?:value|" + ut + ")"), 
                e.querySelectorAll(":checked").length || q.push(":checked");
            }), a(function(e) {
                var t = n.createElement("input");
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && q.push("[*^$]=" + ct + "*(?:''|\"\")"), 
                e.querySelectorAll(":enabled").length || q.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), 
                q.push(",.*:");
            })), (N.matchesSelector = r(I = F.webkitMatchesSelector || F.mozMatchesSelector || F.oMatchesSelector || F.msMatchesSelector)) && a(function(e) {
                N.disconnectedMatch = I.call(e, "div"), I.call(e, "[s!='']:x"), H.push("!=", dt);
            }), q = q.length && RegExp(q.join("|")), H = H.length && RegExp(H.join("|")), z = r(F.contains) || F.compareDocumentPosition ? function(e, t) {
                ...
                return r ? 1 & r || !N.sortDetached && t.compareDocumentPosition(e) === r ? e === n || z(W, e) ? -1 : t === n || z(W, t) ? 1 : L ? st.call(L, e) - st.call(L, t) : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1;
            } : function(e, t) {
                var r, i = 0, o = e.parentNode, a = t.parentNode, s = [ e ], u = [ t ];
                if (e === t) return J = !0, 0;
                if (!o || !a) return e === n ? -1 : t === n ? 1 : o ? -1 : a ? 1 : L ? st.call(L, e) - st.call(L, t) : 0;
                if (o === a) return f(e, t);
            ...
            if ((e.ownerDocument || e) !== R && P(e), t = t.replace(yt, "='$1']"), !(!N.matchesSelector || !$ || H && H.test(t) || q && q.test(t))) try {
                var r = I.call(e, t);
                if (r || N.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r;
            } catch (i) {}
            return n(t, R, null, [ e ]).length > 0;
        }, n.contains = function(e, t) {
            return (e.ownerDocument || e) !== R && P(e), z(e, t);
        }, n.attr = function(e, n) {
            (e.ownerDocument || e) !== R && P(e);
            var r = A.attrHandle[n.toLowerCase()], i = r && et.call(A.attrHandle, n.toLowerCase()) ? r(e, n, !$) : t;
            return i === t ? N.attributes || !$ ? e.getAttribute(n) : (i = e.getAttributeNode(n)) && i.specified ? i.value : null : i;
        }, n.error = function(e) {
            throw Error("Syntax error, unrecognized expression: " + e);
        }, n.uniqueSort = function(e) {
            var t, n = [], r = 0, i = 0;
            if (J = !N.detectDuplicates, L = !N.sortStable && e.slice(0), e.sort(K), J) {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(Nt, jt), e[3] = (e[4] || e[5] || "").replace(Nt, jt), "~=" === e[2] && (e[3] = " " + e[3] + " "), 
                    e.slice(0, 4);
                },
                CHILD: function(e) {
            ...
            filter: {
                TAG: function(e) {
                    var t = e.replace(Nt, jt).toLowerCase();
                    return "*" === e ? function() {
                        return !0;
                    } : function(e) {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        var c, l, f, p, d, h, m = o !== a ? "nextSibling" : "previousSibling", g = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !u && !s;
                        if (g) {
                            if (o) {
                                for (;m; ) {
                            ...
                            if (h = [ a ? g.firstChild : g.lastChild ], a && y) {
                                for (l = g[B] || (g[B] = {}), c = l[e] || [], d = c[0] === X && c[1], p = c[0] === X && c[2], f = d && g.childNodes[d]; f = ++d && f && f[m] || (p = d = 0) || h.pop(); ) if (1 === f.nodeType && ++p && f === t) {
                                    l[e] = [ X, d, p ];
                                    break;
                                }
                            } else if (y && (c = (t[B] || (t[B] = {}))[e]) && c[0] === X) p = c[1]; else for (;(f = ++d && f && f[m] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (y && ((f[B] || (f[B] = {}))[e] = [ X, p ]), 
                            f !== t)); ) ;
                ...
                PSEUDO: function(e, t) {
                    ...
                    return i[B] ? i(t) : i.length > 1 ? (r = [ e, e, "", t ], A.setFilters.hasOwnProperty(e.toLowerCase()) ? o(function(e, n) {
            ...
            pseudos: {
                ...
                lang: o(function(e) {
                    return xt.test(e || "") || n.error("unsupported lang: " + e), e = e.replace(Nt, jt).toLowerCase(), function(t) {
                        var n;
        ...
        M = n.compile = function(e, t) {
            ...
            return o;
        }, A.pseudos.nth = A.pseudos.eq, k.prototype = A.filters = A.pseudos, A.setFilters = new k(), N.sortStable = B.split("").sort(K).join("") === B, 
        P(), [ 0, 0 ].sort(K), N.detectDuplicates = J, ot.find = n, ot.expr = n.selectors, ot.expr[":"] = ot.expr.pseudos, 
    ...
    ot.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return ot.isFunction(e) ? this.each(function(n) {
                ...
                a[s ? "addClass" : "removeClass"](i); else (n === B || "boolean" === n) && (this.className && gt.set(this, "__className__", this.className), 
        ...
        attr: function(e, n, r) {
            ...
            return e && 3 !== a && 8 !== a && 2 !== a ? typeof e.getAttribute === B ? ot.prop(e, n, r) : (1 === a && ot.isXMLDoc(e) || (n = n.toLowerCase(), 
    ...
    var Ct = /^key/, kt = /^(?:mouse|contextmenu)|click/, St = /^(?:focusinfocus|focusoutblur)$/, Nt = /^([^.]*)(?:\.(.+)|)$/;
    ot.event = {
        global: {},
        add: function(e, n, r, i, o) {
            var a, s, u, c, l, f, p, d, h, m, g, v = gt.get(e);
            if (v) {
                for (r.handler && (a = r, r = a.handler, o = a.selector), r.guid || (r.guid = ot.guid++), (c = v.events) || (c = v.events = {}), 
                (s = v.handle) || (s = v.handle = function(e) {
                    return typeof ot === B || e && ot.event.triggered === e.type ? t : ot.event.dispatch.apply(s.elem, arguments);
                }, s.elem = e), n = (n || "").match(st) || [ "" ], l = n.length; l--; ) u = Nt.exec(n[l]) || [], h = g = u[1], 
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (g && (u = g.events)) {
                for (t = (t || "").match(st) || [ "" ], c = t.length; c--; ) if (s = Nt.exec(t[c]) || [], d = m = s[1], 
                h = (s[2] || "").split(".").sort(), d) {
        ...
        trigger: function(n, r, i, o) {
            ...
            if (s = u = i = i || X, 3 !== i.nodeType && 8 !== i.nodeType && !St.test(h + ot.event.triggered) && (h.indexOf(".") >= 0 && (m = h.split("."), 
            ...
            o || !p.trigger || p.trigger.apply(i, r) !== !1)) {
                if (!o && !p.noBubble && !ot.isWindow(i)) {
                    for (c = p.delegateType || h, St.test(c + h) || (s = s.parentNode); s; s = s.parentNode) d.push(s), 
                    u = s;
    ...
    var jt = /^.[^:#\[\.,]*$/, At = /^(?:parents|prev(?:Until|All))/, Dt = ot.expr.match.needsContext, _t = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    ot.fn.extend({
        ...
        ot.fn[e] = function(n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = ot.filter(r, i)), this.length > 1 && (_t[e] || ot.unique(i), 
    ...
    var Mt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ot = /<([\w:]+)/, Lt = /<|&#?\w+;/, Pt = /<(?:script|style|link)/i, Rt = /^(?:checkbox|radio)$/i, Ft = /checked\s*(?:[^=]|=\s*.checked.)/i, $t = /^$|\/(?:java|ecma)script/i, qt = /^true\/(.*)/, Ht = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, It = {
    ...
    It.optgroup = It.option, It.tbody = It.tfoot = It.colgroup = It.caption = It.thead, It.th = It.td, ot.fn.extend({
        ...
        html: function(e) {
            return ot.access(this, function(e) {
                ...
                if ("string" == typeof e && !Pt.test(e) && !It[(Ot.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                    e = e.replace(Mt, "<$1></$2>");
                    try {
        ...
        domManip: function(e, t, n) {
            e = Q.apply([], e);
            var r, i, o, a, s, u, c = 0, l = this.length, f = this, h = l - 1, m = e[0], v = ot.isFunction(m);
            if (v || !(1 >= l || "string" != typeof m || ot.support.checkClone) && Ft.test(m)) return this.each(function(r) {
                var i = f.eq(r);
            ...
            i)) {
                ...
                if (a) for (u = o[o.length - 1].ownerDocument, ot.map(o, d), c = 0; a > c; c++) s = o[c], $t.test(s.type || "") && !gt.access(s, "globalEval") && ot.contains(u, s) && (s.src ? ot._evalUrl(s.src) : ot.globalEval(s.textContent.replace(Ht, "")));
            }
            return this;
        }
    }), ot.each({
        ...
        clone: function(e, t, n) {
            ...
            o = g(e), r = 0, i = o.length; i > r; r++) v(o[r], a[r]);
        ...
        buildFragment: function(e, t, n, r) {
            ...
            i || 0 === i) if ("object" === ot.type(i)) ot.merge(d, i.nodeType ? [ i ] : i); else if (Lt.test(i)) {
                for (o = o || p.appendChild(t.createElement("div")), a = (Ot.exec(i) || [ "", "" ])[1].toLowerCase(), 
                s = It[a] || It._default, o.innerHTML = s[1] + i.replace(Mt, "<$1></$2>") + s[2], c = s[0]; c--; ) o = o.firstChild;
    ...
    var zt, Bt, Wt = /^(none|table(?!-c[ea]).+)/, Xt = /^margin/, Yt = RegExp("^(" + at + ")(.*)$", "i"), Ut = RegExp("^(" + at + ")(?!px)[a-z%]+$", "i"), Gt = RegExp("^([+-])=(" + at + ")", "i"), Vt = {
        BODY: "block"
    }, Jt = {
        position: "absolute",
        visibility: "hidden",
    ...
    ot.fn.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return n = ot.cssProps[u] || (ot.cssProps[u] = y(c, u)), s = ot.cssHooks[n] || ot.cssHooks[u], r === t ? s && "get" in s && (o = s.get(e, !1, i)) !== t ? o : c[n] : (a = typeof r, 
                "string" === a && (o = Gt.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(ot.css(e, n)), a = "number"), 
        ...
        css: function(e, n, r, i) {
            ...
            return n = ot.cssProps[u] || (ot.cssProps[u] = y(e.style, u)), s = ot.cssHooks[n] || ot.cssHooks[u], 
            s && "get" in s && (o = s.get(e, !0, r)), o === t && (o = zt(e, n, i)), "normal" === o && n in Kt && (o = Kt[n]), 
        ...
        ot.support.reliableMarginRight || (ot.cssHooks.marginRight = {
            ...
            ot.cssHooks[n] = {
                get: function(e, r) {
                    return r ? (r = zt(e, n), Ut.test(r) ? ot(e).position()[n] + "px" : r) : t;
                }
            };
        });
    ...
    var an, sn, un = ot.now(), cn = /\?/, ln = /#.*$/, fn = /([?&])_=[^&]*/, pn = /^(.*?):[ \t]*([^\r\n]*)$/gm, dn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, hn = /^(?:GET|HEAD)$/, mn = /^\/\//, gn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, vn = ot.fn.load, yn = {}, bn = {}, xn = "*/".concat("*");
    try {
        sn = W.href;
    } catch (wn) {
    ...
    an = gn.exec(sn.toLowerCase()) || [], ot.fn.load = function(e, n, r) {
        ...
        ajax: function(e, n) {
            function r(e, n, r, s) {
                ...
                r && (b = _(p, T, r)), b = M(p, b, T, c), c ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), 
                ...
                f = b.data, y = b.error, c = !y)) : (y = E, (e || !E) && (E = "error", 0 > e && (e = 0))), T.status = e, 
                T.statusText = (n || E) + "", c ? m.resolveWith(d, [ f, E, T ]) : m.rejectWith(d, [ T, E, y ]), T.statusCode(v), 
                v = t, l && h.trigger(c ? "ajaxSuccess" : "ajaxError", [ T, p, c ? f : y ]), g.fireWith(d, [ T, E ]), 
                l && (h.trigger("ajaxComplete", [ T, p ]), --ot.active || ot.event.trigger("ajaxStop")));
            }
            "object" == typeof e && (n = e, e = t), n = n || {};
            var i, o, a, s, u, c, l, f, p = ot.ajaxSetup({}, n), d = p.context || p, h = p.context && (d.nodeType || d.jquery) ? ot(d) : ot.event, m = ot.Deferred(), g = ot.Callbacks("once memory"), v = p.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
                readyState: 0,
    ...
    e.ActiveXObject && ot(e).on("unload", function() {
        ...
        return ot.support.cors || Cn && !e.crossDomain ? {
            send: function(r, i) {
                ...
                n = function(e) {
                    return function() {
                        n && (delete Nn[a], n = s.onload = s.onerror = null, "abort" === e ? s.abort() : "error" === e ? i(s.status || 404, s.statusText) : i(kn[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                            text: s.responseText
                        } : t, s.getAllResponseHeaders()));
                    };
                }, s.onload = n(), s.onerror = n("error"), n = Nn[a = Sn++] = n("abort"), s.send(e.hasContent && e.data || null);
            },
            abort: function() {
                n && n();
            }
    ...
    var jn, An, Dn = /^(?:toggle|show|hide)$/, _n = RegExp("^(?:([+-])=|)(" + at + ")([a-z%]*)$", "i"), Mn = /queueHooks$/, On = [ F ], Ln = {
        "*": [ function(e, t) {
            var n = this.createTween(e, t), r = n.cur(), i = _n.exec(t), o = i && i[3] || (ot.cssNumber[e] ? "" : "px"), a = (ot.cssNumber[e] || "px" !== o && +r) && _n.exec(ot.css(n.elem, e)), s = 1, u = 20;
            if (a && a[3] !== o) {
                o = o || a[3], i = i || [], a = +r || 1;
    ...
    ot.Animation = ot.extend(P, {
        tweener: function(e, t) {
            ...
            for (var n, r = 0, i = e.length; i > r; r++) n = e[r], Ln[n] = Ln[n] || [], Ln[n].unshift(t);
        },
    ...
    }, ot.timers = [], ot.fx = $.prototype.init, ot.fx.tick = function() {
        ...
        return a ? (n = a.documentElement, ot.contains(n, i) ? (typeof i.getBoundingClientRect !== B && (o = i.getBoundingClientRect()), 
        r = H(a), {
...
function() {
    var e = this, t = e._, n = {}, r = Array.prototype, i = Object.prototype, o = Function.prototype, a = r.push, s = r.slice, u = r.concat, c = i.toString, l = i.hasOwnProperty, f = r.forEach, p = r.map, d = r.reduce, h = r.reduceRight, m = r.filter, g = r.every, v = r.some, y = r.indexOf, b = r.lastIndexOf, x = Array.isArray, w = Object.keys, T = o.bind, E = function(e) {
    ...
    var _ = function(e, t, n, r) {
        ...
        var u = 0, l = !0;
        if ("[object Array]" == i) {
            if (u = e.length, l = u == t.length) for (;u-- && (l = _(e[u], t[u], n, r)); ) ;
        } else {
            for (var f in e) if (E.has(e, f) && (u++, !(l = E.has(t, f) && _(e[f], t[f], n, r)))) break;
            if (l) {
...
window.Modernizr = function(e, t, n) {
    ...
    function c(e, t, n) {
        ...
        return o(t, "string") || o(t, "undefined") ? s(i, t) : (i = (e + " " + S.join(r + " ") + r).split(" "), 
        u(i, t, n));
    }
    function l() {
        h.input = function(n) {
    ...
    var f, p, d = "2.6.2", h = {}, m = !0, g = t.documentElement, v = "modernizr", y = t.createElement(v), b = y.style, x = t.createElement("input"), w = ":)", T = {}.toString, E = " -webkit- -moz- -o- -ms- ".split(" "), C = "Webkit Moz O ms", k = C.split(" "), S = C.toLowerCase().split(" "), N = {
        svg: "http://www.w3.org/2000/svg"
    }, j = {}, A = {}, D = {}, _ = [], M = _.slice, O = function(e, n, r, i) {
        var o, a, s, u, c = t.createElement("div"), l = t.body, f = l || t.createElement("body");
        if (parseInt(r, 10)) for (;r--; ) s = t.createElement("div"), s.id = i ? i[r] : v + (r + 1), c.appendChild(s);
        return o = [ "&#173;", '<style id="s', v, '">', e, "</style>" ].join(""), c.id = v, (l ? c : f).innerHTML += o, 
    ...
    p = o(R, "undefined") || o(R.call, "undefined") ? function(e, t) {
        ...
        var n = M.call(arguments, 1), r = function() {
            if (this instanceof r) {
                ...
                var o = new i(), a = t.apply(o, n.concat(M.call(arguments)));
    ...
    for (var F in j) p(j, F) && (f = F.toLowerCase(), h[f] = j[F](), _.push((h[f] ? "" : "no-") + f));
    return h.input || l(), h.addTest = function(e, t) {
        ...
        var l, f, p = e.html5 || {}, d = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, h = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, m = "_html5shiv", g = 0, v = {};
        (function() {
            try {
        ...
        e.html5 = y, c(t);
    }(this, t), h._version = d, h._prefixes = E, h._domPrefixes = S, h._cssomPrefixes = k, h.mq = L, h.hasEvent = P, 
...
}, "undefined" == typeof RM && (RM = {}), function(e) {
    e.constants = {
        ...
        declination: function(e, t, n, r, i) {
            var o = [ e, t, n ], a = r % 100;
            return a = a >= 11 && 14 >= a ? 0 : 5 > (a %= 10) ? a > 2 ? 2 : a : 0, i || (a = 1 == r ? 1 : 0), o[a];
        },
        ...
        scanForURIs: function(e, t, n) {
            function r(e, r, i, o) {
                ...
                (void 0 == r || "" == r) && (u = "http://" + u);
                var c = i;
                return void 0 != o && "" != o && (c += "." + o), s++, n || (c = u, c = c.replace(/^https?:\/\//, "")), 
                a[s] = "<a " + (t ? 'class = "' + t + '"' : "") + ' href="' + u + '" target="_blank" title="' + u + '">' + c + "</a>", 
            ...
            var a = [], s = 0;
            return e += " ", e = e.replace(/\b([a-z0-9_\.-]+)@([\da-z\.-]+)\.(biz|com|edu|gov|net|org|us|ru|ua|uk|su|se|co|no|jp|it|in|il|gb|fr|fi|es|de|cz|ch|ca|by|at|au)/gim, i), 
            ...
            e = e.replace(/INNER_TMP_BLOCK_([\d]+)_INNER_TMP_BLOCK/gim, o);
        },
        ...
        var r = n[3] + "", i = e.textContent || e.innerText || jQuery(e).text() || "", o = RegExp("(" + r + ")", "i");
        return !!i.match(o);
    }, $.expr[":"].econtains = function(e, t, n) {
        var r = n[3] + "", i = e.textContent || e.innerText || jQuery(e).text() || "", o = RegExp("(^" + r + "$)", "");
        return !!i.match(o);
